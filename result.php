...
<style>
  ...
  margin-bottom: 300px;
  margin-left: -200px; /* Geser teks ke kiri */
...
@media (max-width: 600px) {
  h1.lilita-one-regular {
    ...
    font-size: 24px; /* Ukuran teks lebih kecil untuk perangkat kecil */
    margin-left: 10px; /* Sesuaikan margin kiri untuk layar kecil */
  }
}
...
.card1 {
  ...
  padding: 80px; /* Padding di dalam kartu */
...
@media (max-width: 768px) {
  .card {
    width: 100%; /* Kartu akan mengambil lebar penuh pada layar kecil */
    max-width: 100%; /* Menghilangkan batas maksimum pada layar kecil */
  }
}
            ...
            <div class="intro">
              <div class="flex-wrapper">
                 <div class="container1 py-5">
                  ...
                  <div>
                  <h1 style=" margin-left: -450px;" class="lilita-one-regular font-bold">Sistem Penentuan <br> Pemberian Kredit</h1>
...
<script>
    $(document).ready(function () {
        $('#income').mask('000.000.000', { reverse: true });
